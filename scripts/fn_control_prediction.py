# Optimal next-step control using CEM, based on DKN predictive models.
#
# in: 
#     xc     - current state 
#     xt    - target state
...
#     u  - command
#
# Authors = Edgar Anarossi, Brendan Michael
...
def fn_control_prediction(frozen_func,xc,xt):
	...
	elite_limit = 10   # Number of elite control samples to return
	epsilon     = 0.1
	alpha_mean  = 0.1
	alpha_var   = 0.1
...
#
# in:
#     model - next step predictive model
#     x0 - initial state
#     xt - target state
#     delta_time - 
#     trials - 
