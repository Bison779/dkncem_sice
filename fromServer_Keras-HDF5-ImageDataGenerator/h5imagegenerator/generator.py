...
class HDF5ImageGenerator(Sequence):
    ...
    augmenter : albumentations Compose([]) Pipeline or False
        ...
        Default is False.
    augmenter_labels : albumentations Compose([]) Pipeline or False
        An albumentations transformations pipeline
        to apply to each label.
        Default is False.
    ...
    def __init__(
        ...
        self.augmenter_labels = augmenter_labels
        self.src: str = src
    ...
    def __next_batch(self,
        ...
        if self.augmenter:
            ...
            if self.augmenter_labels:   
                batch_y = np.stack(
                    [self.augmenter_labels(image=y)["image"] for y in batch_y], axis=0)
